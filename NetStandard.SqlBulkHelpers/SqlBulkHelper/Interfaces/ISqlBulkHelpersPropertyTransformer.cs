...
namespace SqlBulkHelpers.Interfaces
{
    ...
    /// </summary>
    public interface ISqlBulkHelpersPropertyTransformer
    {
        object TransformPropValue(object propValue);
    }

    public static class ISqlBulkHelpersPropertyTransformerExtensions
    {
        public static ISqlBulkHelpersPropertyTransformer FindSqlBulkHelpersPropertyTransformer(this PropertyInfo propInfo)
            => propInfo?
                .Attributes()
                .OfType<ISqlBulkHelpersPropertyTransformer>()
                .FirstOrDefault();
    }
}
